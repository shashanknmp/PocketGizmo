...
public class Stock_Transaction_Master {

	public static String TAG = "Stock_Transaction_Master";
	public static String TableName = "Stock_Transaction_Master";
	...
	public Stock_Transaction_Master() {
